...
public class HomeActivity extends BaseGameActivity implements GameHomeFragment.Listener, GameScoreFragment.Listener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Traintracks.getInstance().initialize(this, "https://api.traintracks.io/v1/events", "2.3", "f9a7600b-9677-483b-9697-4a68f759cb21", "d9419951-2f8b-4bf6-9ab0-6f0075afad03", "000111");
        Traintracks.getInstance().setUserName("CaptainCrook");
